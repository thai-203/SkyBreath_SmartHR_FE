...
export default function NotificationDropdown() {
  ...
  const handleClickNotification = async (notification) => {
    ...
    // Nếu không có trang đích thì mở popup modal để đọc chi tiết
    setOpen(false);
    setSelectedNotification(notification);
  };

  const selectedDestination = getNotificationDestination(selectedNotification);
    ...
    <>
      ...
      {selectedNotification &&
        ...
        createPortal(
          ...
          >
            <div
              className="w-full max-w-2xl rounded-2xl bg-white shadow-2xl relative flex flex-col max-h-[85vh] animate-in zoom-in-95 fade-in duration-200"
              ...
              <div className="px-5 py-4 overflow-y-auto flex-1">
                ...
                <div className="mb-4 flex flex-wrap items-center gap-1.5">
                  <span className="inline-flex items-center gap-1 rounded-full bg-indigo-50 px-2 py-0.5 text-[10px] font-semibold text-indigo-600">
                    ...
                    {selectedNotification.sourceType ||
