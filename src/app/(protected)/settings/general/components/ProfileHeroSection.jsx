      ...
      <CardContent className="py-8 px-6">
        <div className="flex flex-col sm:flex-row gap-6">
          ...
          <div className="flex-shrink-0">
            ...
            {!profile?.avatar && (
              <div className="w-40 h-40 rounded-lg bg-gradient-to-br from-slate-200 to-slate-300 flex items-center justify-center text-slate-500 flex-shrink-0 shadow-sm">
          ...
          <div className="flex-1 flex flex-col justify-between">
            ...
            {profile?.status && (
              <div className="pt-4 flex items-center gap-2">
                ...
                <div
                  className={`px-3 py-1 rounded-full text-sm font-semibold ${getStatusColor(profile.status)}`}
                >
