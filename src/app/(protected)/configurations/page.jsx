...
import { Camera, Settings, Shield, Activity, ChevronRight } from "lucide-react";
  ...
  const configurations = [
    {
      ...
      description: "Cài đặt nhận diện khuôn mặt, chống giả mạo và cấu hình camera",
      icon: Camera,
      color: "indigo",
    ...
    },
    {
      ...
      description: "Cài đặt bảo mật IP, vị trí và thiết bị cho hệ thống điểm danh",
      icon: Shield,
      color: "blue",
    ...
    },
    {
      ...
      description: "Cấu hình thời gian làm việc, kỳ công, và các tham số hệ thống",
      icon: Settings,
      color: "purple",
      href: "/configurations/system-settings",
      disabled: true,
    },
    {
          ...
          return (
            <Card
              ...
              className={`transition-all cursor-pointer hover:shadow-lg ${
                config.disabled ? "opacity-50 cursor-not-allowed" : "hover:border-slate-300"
              }`}
        ...
        <CardContent className="space-y-3 text-sm text-slate-700">
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 text-xs ml-2">
              <li>Nhận Diện Khuôn Mặt: Tối ưu hóa độ chính xác và tốc độ xử lý</li>
              <li>Bảo Mật Điểm Danh: Bảo vệ hệ thống khỏi truy cập bất hợp pháp</li>
              <li>Cài Đặt Hệ Thống: Định nghĩa quy tắc và tham số hoạt động</li>
              <li>Cài Đặt Thông Báo: Kiểm soát thông báo và cảnh báo hệ thống</li>
            </ul>
          </div>
          <div>
            <p className="font-medium mb-1">⚠️ Lưu Ý Quan Trọng:</p>
            <p className="text-xs ml-2">
              Các thay đổi cấu hình sẽ áp dụng ngay lập tức. Hãy đảm bảo rằng bạn hiểu rõ tác động của mỗi thay đổi trước khi lưu.
            </p>
          </div>
        </CardContent>
      </Card>
