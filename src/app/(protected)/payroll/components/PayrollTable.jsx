                      ...
                      <div className="relative">
                        ...
                        {openMenu === payroll.id && (
                          ...
                          >
                            ...
                            {isDraft && (
                              <PermissionGate permission="PAYROLL_UPDATE">
                                <button
                                  onClick={() => {
                                    onCalculate(payroll);
                                    setOpenMenu(null);
                            ...
                            {isDraft && (
                              <PermissionGate permission="PAYROLL_APPROVE">
                                <button
                                  onClick={() => {
                                    onSubmit(payroll);
                                    setOpenMenu(null);
                              ...
                              <>
                                <PermissionGate permission="PAYROLL_APPROVE">
                                  <button
                                    ...
                                    className="w-full text-left px-4 py-2 text-sm hover:bg-emerald-50 text-emerald-700"
                                  >
                                    ✅ Phê duyệt
                                  </button>
                                </PermissionGate>
                                <PermissionGate permission="PAYROLL_APPROVE">
                                  <button
                                    ...
                                    className="w-full text-left px-4 py-2 text-sm hover:bg-red-50 text-red-700"
                                  >
                                    ❌ Từ chối
                                  </button>
                                </PermissionGate>
                            ...
                            {isApproved && (
                              <PermissionGate permission="PAYROLL_LOCK">
                                <button
                                  onClick={() => {
                                    onLock(payroll);
                                    setOpenMenu(null);
                            ...
                            <PermissionGate permission="PAYROLL_EXPORT">
                              <button
                                onClick={() => {
                                  onExportSummary(payroll);
                                  setOpenMenu(null);
                                }}
                                className="w-full text-left px-4 py-2 text-sm hover:bg-slate-50 text-slate-700"
                              >
