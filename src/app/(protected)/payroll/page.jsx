...
export default function PayrollPage() {
  ...
  const [detailEditModal, setDetailEditModal] = useState({
    open: false,
    data: null,
  });
  ...
  const detailStatus = detailData
    ? STATUS_LABEL[detailData.payrollStatus]
    : null;
  const canEdit =
    detailData &&
    ["DRAFT", "PENDING_APPROVAL"].includes(detailData.payrollStatus);
