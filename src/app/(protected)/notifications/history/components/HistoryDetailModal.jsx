        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <span
                className={`inline-block rounded-full px-2.5 py-1 text-xs font-medium ${SOURCE_COLORS[record.sourceType] || "bg-slate-100 text-slate-600"}`}
              >
                ...
                {record.recipients.map((r, idx) => (
                  ...
                  >
                    ...
                    <div className="text-right flex-shrink-0">
                      <p
                        className={`text-xs font-medium ${DELIVERY_COLORS[r.deliveryStatus] || "text-slate-400"}`}
                      >
