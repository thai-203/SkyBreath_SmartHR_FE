...
export default function HolidaysPage() {
  ...
  const handleExport = async () => {
    try {
      ...
      link.setAttribute(
        "download",
        `danh-sach-ngay-le${activeGroupName ? `-${activeGroupName}` : ""}.xlsx`,
      );
  ...
  const activeGroupName = groups.find(
    (g) => String(g.id) === String(filterGroupId),
  )?.groupName;
    ...
    <div className="container mx-auto py-8 space-y-6 max-w-7xl">
      ...
      <div className="flex justify-between items-center bg-gray-50/50 p-4 rounded-xl border border-gray-100 shadow-sm">
        ...
        <div className="flex gap-2">
          <PermissionGate permission="HOLIDAY_CONFIG">
          ...
          <PermissionGate permission="HOLIDAY_EXPORT">
            <Button
              variant="outline"
      ...
      <div className="rounded-xl border border-gray-100 bg-white shadow-sm p-6 space-y-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            {filterGroupId && (
              <PermissionGate permission="HOLIDAY_CREATE">
                <Button
                  size="sm"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 bg-gray-50/60 p-4 rounded-xl border border-gray-100">
            <div className="relative">
              ...
              <input
                ...
                onChange={(e) =>
                  setHolidayFilters((p) => ({ ...p, search: e.target.value }))
                }
              />
            </div>
            <div>
              ...
              >
                ...
                <option value="Nghỉ đi du lịch/teambuilding">
                  Nghỉ đi du lịch/teambuilding
                </option>
              </select>
            </div>
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                onChange={(e) =>
                  setHolidayFilters((p) => ({ ...p, endDate: e.target.value }))
                }
              />
            </div>
            <Button
              variant="ghost"
              size="sm"
              className="h-9 text-gray-500 hover:text-blue-600"
              onClick={() =>
                setHolidayFilters({
                  search: "",
                  holidayType: "",
        ...
        {!filterGroupId ? (
          <div className="flex flex-col items-center justify-center py-14 text-gray-400 gap-3">
            ...
            <p className="text-[14px] italic">
              Chọn một nhóm ngày lễ để xem danh sách ngày nghỉ.
            </p>
          </div>
        ) : loadingHolidays ? (
