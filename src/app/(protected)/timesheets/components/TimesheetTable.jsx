      ...
      cols.push(
        {
          ...
          cell: ({ row }) => (
            <span className="font-medium">
              {row.original.totalWorkingDays ?? 0}
            </span>
          ),
        },
        {
          ...
          header: "Giờ công",
          size: 90,
          cell: ({ row }) => <span>{row.original.totalWorkingHours ?? 0}</span>,
        },
        {
          ...
          cell: ({ row }) => {
            ...
            return (
              <span
                className={
                  ot > 0 ? "text-orange-600 font-medium" : "text-slate-400"
                }
              >
                {ot}
              </span>
        ...
        <div className="flex items-center gap-1">
          ...
          {!row.original.isLocked && (
            <>
              ...
              {(mode === "all" || mode === "generation") && (
                <PermissionGate permission="TIMESHEET_CREATE">
                  <Button
                    variant="ghost"
                    size="icon"
    ...
    <Card>
      <CardHeader className="border-b border-slate-200">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <PermissionGate permission="TIMESHEET_READ">
