...
export default function RequestTypesTable({
    ...
    const renderTrackingCycle = (val) => {
        const mapping = { "DAY": "Ngày", "WEEK": "Tuần", "MONTH": "Tháng", "YEAR": "Năm" };
        return mapping[val] || val;
    };
    const renderUnit = (val) => {
        const mapping = { "DAY": "Ngày", "HOUR": "Giờ", "MINUTE": "Phút", "TIME": "Lần" };
        return mapping[val] || val;
    };
                ...
                <Table>
                    ...
                    <TableBody>
                        {loading ? (
                            ...
                            <TableRow>
                                <TableCell colSpan={7} className="text-center h-24 text-slate-500">Chưa có dữ liệu</TableCell>
                            </TableRow>
                        ) : (
                            data.map((item, index) => (
