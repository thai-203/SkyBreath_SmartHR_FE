...
import { Calendar, Layout, Briefcase, User, Mail, ChevronRight } from "lucide-react";
      ...
      <table className="w-full text-left border-separate border-spacing-y-3">
        ...
        <tbody>
          {progressList.map((p) => (
            <tr
              key={p.id}
              className="group bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-indigo-100 transition-all"
...
function StatusBadge({ status }) {
  ...
  return (
    <span className={`inline-flex items-center px-3 py-1 rounded-xl text-[10px] font-black border uppercase tracking-wider ${config.className}`}>
