          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
            <div className="space-y-1">
              ...
              <select
                ...
                onChange={(e) =>
                  handleFilterChange("violationType", e.target.value)
                }
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-slate-200 bg-slate-50">
              ...
              <th className="px-4 py-3 text-center text-xs font-semibold uppercase tracking-wider text-slate-500 w-28">
                Hành động
              </th>
            </tr>
          </thead>
              ...
              data.map((penalty, index) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-sm">
                    <span
                      className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold ${violationTypeColors[penalty.violationType] || "bg-slate-100 text-slate-600"}`}
                    >
                      {violationTypeLabels[penalty.violationType] ||
                  ...
                  <td className="px-4 py-3 text-center text-sm text-slate-600">
                    {penalty.convertedHours}
                  </td>
                  <td className="px-4 py-3 text-center text-sm text-slate-600">
                    {formatDate(penalty.effectiveFrom)}
                  </td>
                  <td className="px-4 py-3 text-center text-sm text-slate-600">
                    {formatDate(penalty.effectiveTo)}
                  </td>
                  ...
                  <td className="px-4 py-3 text-center">
                    <div className="flex items-center justify-center gap-1">
                      <PermissionGate permission="PENALTY_UPDATE">
                        <button
                      ...
                      <PermissionGate permission="PENALTY_DELETE">
                        <button
              ...
              <tr>
                ...
                >
                  {search || hasActiveFilters
                    ? "Không tìm thấy quy định vi phạm phù hợp"
                    : "Chưa có quy định vi phạm nào"}
                </td>
              </tr>
            )}
          </tbody>
